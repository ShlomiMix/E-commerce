...
import "./ImageMultipleInput.css";

interface ImageMultipleInputProps {
...
export function ImageMultipleInput({
  imagesUrl,
  register,
  required,
  onChange,
...
}: ImageMultipleInputProps): JSX.Element {
